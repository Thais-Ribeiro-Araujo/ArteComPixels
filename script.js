...
// https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Math/random //https://www.udacity.com/blog/2021/04/javascript-random-numbers.html
// requisito bonus gerador de cores aleatorias
...
function addPixelSquare(size) {
  for (let index1 = 0; index1 < size; index1 += 1) {
    ...
    for (let index2 = 0; index2 < size; index2 += 1) {
      const lineBoardIn = document.querySelectorAll('.lineBoard')[index1];
      const pixel = document.createElement('div');
      pixel.className = 'pixel';
      lineBoardIn.appendChild(pixel);
    }
  }
}
